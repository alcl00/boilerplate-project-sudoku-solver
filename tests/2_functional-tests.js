...
suite("Functional Tests", () => {
  ...
  suite("POST /api/solve => solve given puzzle string", function () {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          assert.property(
            res.body,
            "solution",
            "POST should return property solution"
          );
      ...
      chai
        ...
        .end((err, res) => {
          ...
          assert.property(
            res.body,
            "error",
            "POST should return property error"
          );
    ...
    test("Invalid characters", function (done) {
      let invalidInput =
        "5..91372.3...8.5.9.9.25..8.68.47.23$..9%..AB.7.4.....5.2.......4..8916..85.72...3";
      chai
        .request(server)
        .keepOpen()
        .post("/api/solve")
    ...
    test("Incorrect length (not 81 characters long)", function (done) {
      ...
      let shortInput = "123...";
      let longInput =
        "5..91372.3...8.5.9.9.25..8.68.47.23...95..46.7.4.....5.2.......4..8916..85.72...3..1234...12388888....";
      ...
      chai
        ...
        .end((err, res) => {
          ...
          assert.property(
            res.body,
            "valid",
            "POST should return property valid"
          );
      ...
      chai
        ...
        .end((err, res) => {
          ...
          assert.property(
            res.body,
            "conflict",
            "POST should return property conflict"
          );
          assert.isBoolean(res.body.valid);
